...
import com.group2.project2.entities.permissionEntity;
...
//        App.setRoot("dashboard");
    ...
    @FXML
    void switchToStudent() throws IOException {
        switchToLayout(2);
    }
    @FXML
    void switchToTeacher() throws IOException {
        switchToLayout(3);
    }
    @FXML
    ...
    public void switchToMasterApp() throws IOException {
        StaffController.resetData();
        App.setRoot("MasterApp");
    }

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        staff sta = StaffController.staffInstance();
        ...
        lbl_sta_role.setText(permissionEntity.findById(sta.getPermission_id()).getRole());
