...
public class mark {
    ...
    public mark(int id, int subject_id, String student_rollno, float mark_t1, float mark_p1, TimeUnit create_at1, float mark_t2, float mark_p2, TimeUnit create_at2) {
        this.id = id;
